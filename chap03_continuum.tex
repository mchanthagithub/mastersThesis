...
Expanding the constraint $\Phi\left( \tau\left( \bm{b}^{e,p} \right) \right) = 0$, we find:
\begin{align}
\begin{aligned}
  %\Phi\left( \tau \left( \bm{b}^{e,p} \right) \right) &= \| dev[ \tau\left( \bm{b}^{e,p} \right) ] \|_F + \frac{\alpha}{2} \Tr[ \tau\left( \bm{b}^{e,p} \right) ] \\
  %                                                            &= \mu \| dev[\bm{b}^{e,p}] \|_F + \alpha \frac{\kappa}{2} ( J^2 - 1 ) \\
...
\begin{align}
\begin{aligned}
  %det[\bm{b}^{e,p}] &= det[ \lambda_1 \bm{I} + \lambda_2 dev[\boldsymbol{b}^{e,*}] ] \\
  %                           &= \lambda_1^2 det[ \bm{I} + \frac{\lambda_2}{\lambda_1} dev[\bm{b}^{e,*}] ].
...
\end{aligned}
\end{align}
Equating to $det[\bm{b}^{e,*}]$ and solving for $\lambda_1$ we find:
\begin{align}
